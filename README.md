...
To build the final jar and optimize the apiGatewayApplication application for production, run:
...
Then navigate to [http://localhost:8381](http://localhost:8381) in your browser.
